...
static void install_params(carmen_localize_motion_model_t *model,
			   int argc, char *argv[])
{
...
carmen_localize_motion_model_t *carmen_localize_motion_initialize(int argc, char *argv[])
{
  ...
  model = (carmen_localize_motion_model_t *)
    calloc(1, sizeof(carmen_localize_motion_model_t));
...
double carmen_localize_sample_noisy_downrange(double delta_t, 
					      double delta_theta,
					      carmen_localize_motion_model_t 
					      *model)
{
...
double carmen_localize_sample_noisy_crossrange(double delta_t, 
					       double delta_theta,
					       carmen_localize_motion_model_t 
					       *model)
{
...
double carmen_localize_sample_noisy_turn(double delta_t, double delta_theta,
					 carmen_localize_motion_model_t *model)
{
