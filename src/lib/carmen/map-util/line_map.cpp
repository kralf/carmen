			       ...
			       carmen_linemapping_parameters_t* param )
{
  carmen_param_t param_list[] = {
    ...
    {(char*)"linemapping", (char*)"laser_maxrange", CARMEN_PARAM_DOUBLE, 
     &param->laser_max_length, 0, NULL},
    {(char*)"linemapping", (char*)"sam_tolerance", CARMEN_PARAM_DOUBLE, 
     &param->sam_tolerance, 0, NULL},
    {(char*)"linemapping", (char*)"sam_max_gap", CARMEN_PARAM_DOUBLE, 
     &param->sam_max_gap, 0, NULL},
    {(char*)"linemapping", (char*)"sam_min_length", CARMEN_PARAM_DOUBLE, 
     &param->sam_min_length, 0, NULL},
    {(char*)"linemapping", (char*)"sam_min_num", CARMEN_PARAM_INT, 
     &param->sam_min_num, 0, NULL},
    {(char*)"linemapping", (char*)"sam_use_fit_split", CARMEN_PARAM_ONOFF, 
     &param->sam_use_fit_split, 0, NULL},

    {(char*)"linemapping", (char*)"merge_max_dist", CARMEN_PARAM_DOUBLE, 
     &param->merge_max_dist, 0, NULL},
    {(char*)"linemapping", (char*)"merge_min_relative_overlap",
      CARMEN_PARAM_DOUBLE, &param->merge_min_relative_overlap, 0, NULL},
    {(char*)"linemapping", (char*)"merge_overlap_min_length",
      CARMEN_PARAM_DOUBLE, &param->merge_overlap_min_length, 0, NULL},
    {(char*)"linemapping", (char*)"merge_uniformly_distribute_dist",
      CARMEN_PARAM_DOUBLE, &param->merge_uniformly_distribute_dist, 0,
NULL}
				     ...
				     int index_no_element)
{
  ...
  double best_similar_angle = DBL_MAX;;
