...
segway_t segway;
double segway_command_tv, segway_command_rv;
double segway_last_command;
int segway_quit_signal;
				    ...
				    void *clientData __attribute__ ((unused)))
{
  ...
  segway_command_tv = vel.tv;
  segway_command_rv = vel.rv;
  segway_last_command = carmen_get_time();

  fprintf(stderr, "\rTV = %.1f     RV = %.1f   Battery = %d%%     ",
          segway_command_tv, segway_command_rv, (int)segway.voltage);
}
