...
class RobotLaserMessage : public AbstractMessage {
 public:
  ...
  RobotLaserMessage(const carmen_robot_laser_message& x);
  RobotLaserMessage(carmen_robot_laser_message* x);
  RobotLaserMessage(char* s);

  virtual ~RobotLaserMessage();

  void setRobotLaserMessage(carmen_robot_laser_message* x);
  ...
  void clone(const carmen_robot_laser_message& x);
  ...
  carmen_inline carmen_robot_laser_message* toCarmenMsg()   {return m_msg;}
  carmen_inline operator carmen_robot_laser_message*()      {return m_msg;}
  carmen_inline operator const carmen_robot_laser_message&() const {return *m_msg;}
  carmen_inline operator carmen_robot_laser_message&() {return *m_msg;}
