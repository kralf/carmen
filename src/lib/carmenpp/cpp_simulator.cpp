...
TrueposMessage::TrueposMessage(const carmen_simulator_truepos_message& x) {
  m_msg = NULL;
  clone(x);
}

TrueposMessage::TrueposMessage(carmen_simulator_truepos_message* x) {
  m_msg = NULL;
  setTrueposMessage(x);
}
...
void TrueposMessage::save(carmen_FILE *logfile, double logger_timestamp) {
  carmen_logwrite_write_truepos(m_msg, logfile, logger_timestamp);
}
...
void TrueposMessage::setTrueposMessage( carmen_simulator_truepos_message* x) {
  m_msg = x;
}
...
void TrueposMessage::clone(const carmen_simulator_truepos_message& x) {
