...
class TrueposMessage : public AbstractMessage {
 public:
  ...
  TrueposMessage(const carmen_simulator_truepos_message& x);
  TrueposMessage(carmen_simulator_truepos_message* x);
  TrueposMessage(char* s);
  virtual ~TrueposMessage();

  void init();
  void clone(const TrueposMessage& x);
  void clone(const carmen_simulator_truepos_message& x);
  void setTrueposMessage(carmen_simulator_truepos_message* x);
  void free();
  ...
  carmen_inline carmen_simulator_truepos_message* toCarmenMsg() {return m_msg;}
  carmen_inline operator carmen_simulator_truepos_message*() {return m_msg;}
  carmen_inline operator const carmen_simulator_truepos_message&() const {return *m_msg;}
  carmen_inline operator carmen_simulator_truepos_message&() {return *m_msg;}
