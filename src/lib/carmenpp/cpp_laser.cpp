...
const float* LaserMessage::getRange() const{
  return m_msg->range;
}

const float* LaserMessage::getRemission() const{
  return m_msg->remission;
}

float* LaserMessage::getRange() {
  return m_msg->range;
}

float* LaserMessage::getRemission() {
  return m_msg->remission;
}
...
float LaserMessage::getRange(int i) const {
  return m_msg->range[i];
}

void LaserMessage::setRange(int i, float val) {
  m_msg->range[i] = val;
}
...
float LaserMessage::getRemission(int i) const {
  return m_msg->remission[i];
}

void LaserMessage::setRemission(int i, float val) {
